/**
 * Priority 5: Pre-deploy CDN Verification Script
 * Checks all external CDN resources used by the portfolio.
 * Validates availability, correct MIME type, and expected content signature.
 * Run with: node scripts/verify-lucide-cdn.cjs
 */
...
const CDN_RESOURCES = [
    {
        ...
        contentSignature: 'createIcons', // must appear in response body
    },
    {
